...
* <span style="color:DimGray; font-size:85%">[2025/01]</span> <span style="font-size:95%"> <span style="color:OrangeRed">(Award)</span> 1 ASP-DAC'25 Best Paper Nomination (SMART-GPO).</span>   
...
* <span style="color:DimGray; font-size:85%">[2024/10]</span> <span style="font-size:95%"> <span style="color:Green">(Paper)</span> 1 IEEE TCAD'25 paper (RTL-Coder) accepted, first-authored by *Shang*.</span>   
...
* <span style="color:DimGray; font-size:85%">[2024/08]</span> <span style="font-size:95%"> <span style="color:OrangeRed">(Award)</span> 1 ISLPED'24 Best Paper Nomination (AgileDev), first-authored by *Yao*.</span> 
...
* <span style="color:DimGray; font-size:85%">[2024/06]</span> <span style="font-size:95%"> <span style="color:OrangeRed">(Award)</span> 1 LAD'24 Best Paper Nomination (RTL-Coder), first-authored by *Shang*.</span> 
